...
extern "C"
{
    ...
    long long int wrap_h2gis_connect(graal_isolatethread_t *thread, char *path,
                                     char *user, char *pass);
    long long int wrap_h2gis_load(graal_isolatethread_t *thread,
                                  long long int conn);
    long long int wrap_h2gis_fetch(graal_isolatethread_t *thread,
                                   long long int rs, char *sql);
    int wrap_h2gis_execute(graal_isolatethread_t *thread, long long int conn,
                           char *sql);
    long long int wrap_h2gis_prepare(graal_isolatethread_t *thread,
                                     long long int conn, char *sql);
    void wrap_h2gis_bind_double(graal_isolatethread_t *thread,
                                long long int stmt, int idx, double val);
    void wrap_h2gis_bind_int(graal_isolatethread_t *thread, long long int stmt,
                             int idx, int val);
    void wrap_h2gis_bind_long(graal_isolatethread_t *thread, long long int stmt,
                              int idx, long long int val);
    void wrap_h2gis_bind_string(graal_isolatethread_t *thread,
                                long long int stmt, int idx, char *val);
    void wrap_h2gis_bind_blob(graal_isolatethread_t *thread, long long int stmt,
                              int idx, char *data, int len);
    int wrap_h2gis_execute_prepared_update(graal_isolatethread_t *thread,
                                           long long int stmt);
    long long int wrap_h2gis_execute_prepared(graal_isolatethread_t *thread,
                                              long long int stmt);
    void wrap_h2gis_close_query(graal_isolatethread_t *thread,
                                long long int handle);
    void wrap_h2gis_close_connection(graal_isolatethread_t *thread,
                                     long long int conn);
    void wrap_h2gis_delete_database_and_close(graal_isolatethread_t *thread,
                                              long long int conn);
    void *wrap_h2gis_fetch_all(graal_isolatethread_t *thread, long long int rs,
                               void *sizeOut);
    void *wrap_h2gis_fetch_one(graal_isolatethread_t *thread, long long int rs,
                               void *sizeOut);
    void *wrap_h2gis_fetch_batch(graal_isolatethread_t *thread,
                                 long long int rs, int batchSize,
                                 void *sizeOut);
    void *wrap_h2gis_get_column_types(graal_isolatethread_t *thread,
                                      long long int stmt, void *sizeOut);
    char *wrap_h2gis_get_metadata_json(graal_isolatethread_t *thread,
                                       long long int conn);
    long long int wrap_h2gis_free_result_set(graal_isolatethread_t *thread,
                                             long long int rs);
    void wrap_h2gis_free_result_buffer(graal_isolatethread_t *thread,
                                       void *buffer);
