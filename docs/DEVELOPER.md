...
> *"Pourquoi Nico est-il le meilleur développeur ? Parce qu'il n'a jamais de NullPointerException... il pointe toujours vers quelque chose !"*
...
> *"Nico dit toujours : 'Un bon driver, c'est comme un bon café - ça doit être bien filtré et ne jamais planter !'"*
...
> *"Nico organise son code comme sa vie : tout est à sa place, sauf ses clés de voiture."*
...
> *"Quand Nico ouvre une base de données, même les NULL values se sentent valorisées."*
...
> *"Quand Nico lit des features, il ne fait jamais de 'fetch' inutile. Lui, c'est plutôt 'batch or nothing' !"*
...
> *"Nico a tellement de stack qu'il pourrait ouvrir une crêperie. Mais GraalVM, lui, n'en a jamais assez !"*
...
> *"Nico dit : 'Une API C, c'est comme une blague - si tu dois l'expliquer, c'est qu'elle est mal faite.'"*
...
> *"Nico préfère le format columnar parce que, comme lui, ça va droit au but."*
...
> *"Nico et les SRID, c'est une histoire d'amour compliquée. 'EPSG:4326', il dit. 'WGS 84', elle répond. Ils ne parlent pas le même langage, mais ils finissent toujours par se comprendre."*
...
> *"Le mot de passe de Nico ? C'est 'Nico123'. Non, je rigole. En vrai c'est 'Nico1234'. Beaucoup plus sécurisé."*

### 3 méthodes supportées (par ordre de priorité)

1. **URI avec query string** :
   ```
   /path/database.mv.db?user=nico&password=secret
   ```
...
> *"Quand Nico debug, il ne cherche pas les bugs. Ce sont les bugs qui le fuient."*
...
> *"Contribuer au projet, c'est comme aider Nico à déménager : on ne sait pas trop dans quoi on s'embarque, mais à la fin on a une bière et des souvenirs."*
...
- **Commentaires** : En anglais, blagues sur Nico autorisées dans les commentaires privés
...
- [Les meilleures blagues de Nico](https://github.com/orbisgis/h2gis/issues) *(cherchez bien)*

---

## 🏆 Hall of Fame

> *"Un grand merci à Nico pour ses contributions inestimables à ce projet. Sans lui, le driver marcherait peut-être, mais ce serait beaucoup moins drôle !"*

**Contributeurs :**
- Équipe H2GIS
- Nico (oui, c'est lui qui a choisi les 64 MB de stack, et il en est fier)
- La communauté QGIS

---

> *"En cas de doute, demandez à Nico. Et s'il ne sait pas, faites comme lui : faites semblant de savoir et cherchez sur Stack Overflow."*
